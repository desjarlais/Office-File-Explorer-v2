namespace ScintillaNET_FindReplaceDialog
{
    ...
    public partial class IncrementalSearcher : UserControl
    {
        ...
        public void findNext()
        {
            ...
            Office_File_Explorer.CharacterRange r = _findReplace.FindNext(txtFind.Text, true, _findReplace.Window.GetSearchFlags());
            if (r.cpMin != r.cpMax)
        ...
        private void findPrevious()
        {
            ...
            Office_File_Explorer.CharacterRange r = _findReplace.FindPrevious(txtFind.Text, true, _findReplace.Window.GetSearchFlags());
            if (r.cpMin != r.cpMax)
                _scintilla.SetSel(r.cpMin, r.cpMax);
        ...
        private void txtFind_TextChanged(object sender, EventArgs e)
        {
            ...
            Office_File_Explorer.CharacterRange r = _findReplace.Find(pos, _scintilla.TextLength, txtFind.Text, _findReplace.Window.GetSearchFlags());
            if (r.cpMin == r.cpMax)
