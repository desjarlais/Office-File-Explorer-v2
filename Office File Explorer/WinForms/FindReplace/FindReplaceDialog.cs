    ...
    public partial class FindReplaceDialog : Form
    {
        ...
        private void btnFindAll_Click(object sender, EventArgs e)
        {
            ...
            if (rdoRegexF.Checked)
            {
                ...
                {
                    lblStatus.Text = Office_File_Explorer.Properties.Resources.ErrorSummary + ex.Message;
                    return;
                }
        ...
        private void btnReplacePrevious_Click(object sender, EventArgs e)
        {
            ...
            {
                lblStatus.Text = "Error in regex" + ex.Message;
                return;
            }

            if (nextRange.cpMin == nextRange.cpMax)
            {
                lblStatus.Text = Strings.sciMatchNotFound;
            }
            else
            {
                ...
                {
                    if (chkSearchSelectionR.Checked)
                        lblStatus.Text = Strings.sciMatchWrappedBeginningSelection;
                    else
                        lblStatus.Text = Strings.sciMatchWrappedBeginningDocument;
                }
        ...
        public void FindNext()
        {
            ...
            {
                lblStatus.Text = Strings.sciErrorInRegex + ex.Message;
                return;
            }
        ...
        public void FindPrevious()
        {
            ...
            else
            {
                ...
                {
                    if (chkSearchSelectionF.Checked)
                        lblStatus.Text = Strings.sciMatchWrappedEndSelection;
                    else
                        lblStatus.Text = Strings.sciMatchWrappedEndDocument;
                }
